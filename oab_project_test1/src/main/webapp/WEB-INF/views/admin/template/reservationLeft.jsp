...
<div class="left">
	...
	<ul>
		...
		<li><a href="/admin/reservation/adminReservationCompleteList?page=1&order_by=rest_status&order_sc=ASC">예약완료</a></li>
		...
		<li><a href="/admin/rental/adminRentalList?page=1&order_by=rent_status&order_sc=ASC">대여/반납</a></li>
	</ul>
</div>
</c:if>