...
<body>
	<div class="policy_container">
		<p class="policy_title">개인정보취급방침</p>
		<article class="policy_text">
		    "OAB텐트"는 정보주체의 동의, 「전자정부법」 및 「개인정보 보호법」 등 관련 법령상의 개인정보 보호 규정을 준수하여 이용자의 개인정보 보호 및 권익을 보호하고 개인정보와 관련한 이용자의 고충을 원활하게 처리할 수 있도록 다음과 같은 처리방침을 두고 있습니다.
                            <br/>
                            <br/>
                            <strong>제1조(개인정보의 처리 목적)</strong>
                            <br/> 
                            "OAB텐트"는 다음 각 호에서 열거한 목적을 위하여 최소한으로 개인정보를 처리하고 있습니다. 처리한 개인정보는 다음의 목적 이외의 용도로는 이용되지 않으며, 이용 목적이 변경되는 경우에는 「개인정보 보호법」 제18조에 따라 별도의 동의를 받는 등 필요한 조치를 이행하고 있습니다. 
                            <br/>
                            <br/>
                            1. 회원가입 및 관리
                            <br/>
                            ...
                            3. 생활정보 열람서비스 제공
                            <br/>
                            OAB텐트 회원의 경우, 전자정부법 제9조의2에 의한 본인의 생활정보 열람 
                            <br/>  
                            4. 알려드림e 사용자 정보 관리
                            <br/>
                            ...
                            <br/>
                            "OAB텐트"에서 처리하는 개인정보는 수집·이용 목적으로 명시한 범위 내에서 처리하며, 개인정보보호법 및 관련 법령에서 정하는 보유기간을 준용하여 이행하고 있습니다.
                            <br/>
                            <br/>
                            1. OAB텐트 회원정보<br/>
                            ...
                            &nbsp;&nbsp;&nbsp;- 보유기간 : 탈퇴 후 5일까지<br/>
                            6. 공공서비스 목록 열람ㆍ신청, 자격연계 정보<br/>
                            &nbsp;&nbsp;&nbsp;- 수집근거 : 정보주체의 동의, 전자정부법 제12조의 3 제2항, 전자정부법 제12조의4, 전자정부법 제38조 및 같은 법 시행령 제43조와 제90조제4항<br/>
                            &nbsp;&nbsp;&nbsp;- 보유기간 : 공공서비스 목록 제공 완료시 까지 <br/>
                            <br/>
                            ...
                            <br/>
                            "OAB텐트"는  원칙적으로 정보주체의 개인정보를 수집·이용 목적으로 명시한 범위 내에서 처리하며, 다음의 경우를 제외하고는 정보주체의 사전 동의 없이는 본래의 목적 범위를 초과하여 처리하거나 제3자에게 제공하지 않습니다. 다만, 제5호부터 제9호까지는 공공기관의 경우로 한정합니다.  
                            <br/><br/>
                            ...
                            <br/>
                            <br/>
                            <strong>제4조(개인정보 처리 위탁)</strong>
                            <br/>
                            1. "OAB텐트"는 원활한 개인정보 업무처리 서비스를 위해 다음과 같이 개인정보 처리업무를 위탁 운영하고 있습니다.<br/>
			                            가. 위탁받는 자(수탁자) : (주)솔리데오시스템즈<br/>
							&nbsp;&nbsp;&nbsp;- 위탁하는 업무의 내용 : 시스템 개발 및 유지보수 수행<br/>
							&nbsp;&nbsp;&nbsp;- 위탁기간 : 1년<br/>
							&nbsp;&nbsp;&nbsp;- 연락처 : 070-7825-4470<br/>
							&nbsp;&nbsp;&nbsp;- 근무시간 : 09:00 ~ 18:00<br/>
							    나. 위탁받는 자(수탁자) : (주)데이타솔루션<br/>
							&nbsp;&nbsp;&nbsp;- 위탁하는 업무의 내용 : 시스템 개발 및 유지보수 수행<br/>
							&nbsp;&nbsp;&nbsp;- 위탁기간 : 1년<br/>
							&nbsp;&nbsp;&nbsp;- 연락처 : 070-7825-0156<br/>
							&nbsp;&nbsp;&nbsp;- 근무시간 : 09:00 ~ 18:00<br/>
							    다. 위탁받는 자(수탁자) : 엔에이치엔페이코(주)<br/>
							&nbsp;&nbsp;&nbsp;- 위탁하는 업무의 내용 : 페이코 이용 간편결제 서비스<br/>
							&nbsp;&nbsp;&nbsp;- 위탁기간 : 회원탈퇴 시 혹은 위탁계약 종료 시 까지<br/>
							&nbsp;&nbsp;&nbsp;- 연락처 : 1544-6891<br/>
							&nbsp;&nbsp;&nbsp;- 근무시간 : 09:00 ~ 18:00<br/>
							    라. 위탁받는 자(수탁자) : (주)카카오<br/>
							&nbsp;&nbsp;&nbsp;- 위탁하는 업무의 내용 : 카카오페이 이용 간편결제 서비스<br/>
							&nbsp;&nbsp;&nbsp;- 위탁기간 : 회원탈퇴 시 혹은 위탁계약 종료 시 까지<br/>
							&nbsp;&nbsp;&nbsp;- 연락처 : 1644-7405<br/>
							&nbsp;&nbsp;&nbsp;- 근무시간 : 09:00 ~ 18:00<br/>
                            ...
                            &nbsp;&nbsp;&nbsp;다. 삭제 요구<br/>
                            &nbsp;&nbsp;&nbsp;라. 처리정지 요구<br/>
                            2. 제1항에 따른 권리 행사는 "OAB텐트"에 대해 「개인정보 보호법 시행규칙」 별지 제8호 서식에 따라 작성 후 서면, 전자우편, 모사전송(FAX) 등을 통하여 하실 수 있으며, "OAB텐트"는 이에 대해 지체 없이 조치하겠습니다.<br/>
                            ...
                            <br/>
                            "OAB텐트"가 처리하는 개인정보 항목은 다음 각 호와 같습니다. 
                            <br/>
                            <br/>
                            1. OAB텐트 회원정보<br/>
                            &nbsp;&nbsp;① 회원정보<br/>
                            ...
                            6. 공공서비스 목록 열람ㆍ신청, 자격연계 정보<br/>
                            &nbsp;&nbsp;&nbsp;- 필수항목 :  성명, 주민등록번호, 주소, 이메일, 휴대전화번호, 임신/출산 사실여부, 사업자 등록 사실 여부, 건강보험자격득실확인서 정보, 주민등록등본 정보, 자활근로자 사실 여부, 의사상자 사실 여부, 북한이탈주민 여부, 농업경영체증명서 정보, 장애인 정보, 기초생활수급대상자 정보, 차상위 대상자 정보, 축산업등록 사실 여부, 공장 소유 여부, 한부모가족 사실 여부, 기초연금 수급 여부, 국민연금 가입 여부, 국가기술자격취득 정보, 고용보험 가입 여부, 가족관계등록 정보, 주택 소유 여부<br/>
                            <br/>
                            <br/>
                            <strong>제7조(개인정보의 파기 절차 및 방법) </strong>
                            <br/>
                            "OAB텐트"는 원칙적으로 개인정보 보존기간이 경과하거나, 처리목적이 달성된 경우에는 지체 없이 해당 개인정보를 파기합니다. 다만, 다른 법령에 따라 보존하여야 하는 경우에는 그러하지 않을 수 있습니다. 파기 절차, 기한 및 방법은 다음과 같습니다.
                            <br/>
                            <br/>
                            1. 파기절차
                            <br/>
                            ...
                            <br/>
                            <br/>
                            <strong>제8조(개인정보 자동 수집 장치의 설치ㆍ운영 및 거부에 관한 사항)</strong>
                            <br/>
                            1. "OAB텐트"는 이용자에게 개인형 서비스를 제공하기 위해 이용정보를 저장하고 수시로 불러오는 '쿠키(cookie)'를 사용합니다.<br/>
                            ...
                            3. 접속기록의 보관<br/>
                            개인정보처리시스템에 접속한 기록을 최소 6개월 이상 보관·관리하고 있습니다. <br/>
                            4. 개인정보의 암호화<br/>
                            ...
                            <br/>
                            <br/>
                            <strong>제11조(개인정보 분야별 책임관 및 담당자 연락처)</strong>
                            <br/>
                            <br/>
                            1. 개인정보 보호책임관 : 행정안전부 정책기획관 류임철<br/>
                            2. 개인정보보호 분야별 책임관 : 행정안전부 행정서비스통합추진단 OAB텐트운영팀장 조성하 (02-2100-4140)<br/>
                            3. 개인정보취급자<br/>
                            &nbsp;&nbsp;&nbsp; - 담당자 : 행정안전부 행정서비스통합추진단 OAB텐트운영팀 장현석<br/>
   							&nbsp;&nbsp;&nbsp;- 연락처 : 02-2100-4138 (Fax 02-2100-4142) 전자메일 : jang2013@korea.kr 
                            <br/>
                            <br/>
                            <strong>제12조(개인정보 열람청구)</strong>
                            <br>
                            1. 정보주체는 개인정보 보호법 제35조에 따른 개인정보의 열람청구를 아래의 부서에 할 수 있습니다. 행정안전부 행정서비스통합추진단 OAB텐트운영팀은 정보주체의 열람청구가 신속하게 처리되도록 노력하겠습니다.
                            <br>  
						    &nbsp;&nbsp;&nbsp;-부서명 : 행정안전부 행정서비스통합추진단 OAB텐트 운영팀<br>
						    &nbsp;&nbsp;&nbsp;-담당자 : 장현석<br>
						    &nbsp;&nbsp;&nbsp;-연락처 : 02-2100-4138 (Fax 02-2100-4142) 전자메일 : jang2013@korea.kr<br>
							...
							<br> 
   							...
   							<br>
   							<br>
                            <strong>제13조(개인정보처리방침 변경)</strong>
                            <br/>
                            이 개인정보 처리방침은 2019. 7. 12. 부터 적용됩니다. 이전의 개인정보 처리방침은 아래에서 확인하실 수 있습니다.
