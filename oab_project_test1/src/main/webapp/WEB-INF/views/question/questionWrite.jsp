...
<body>
	<c:if test="${login.mt_id != null }">
		...
		<div class="questionContentContainer">
			...
			<div class="ContentTB">
				<form id="questionwriteForm" name="questionwriteForm" enctype="multipart/form-data">
					<table id="questionWrite">
						...
						<tr>
							<td class="ac">이름 *</td>
							<td><input type="text" name="qt_writer" id="qt_writer" placeholder="필수 사항입니다."></td>
						</tr>
						<tr>
						...
						<tr>
							<td class="ac">제목 *</td>
							<td><input type="text" name="qt_title" id="qt_title" placeholder="필수 사항입니다"></td>
						</tr>
						<tr>
