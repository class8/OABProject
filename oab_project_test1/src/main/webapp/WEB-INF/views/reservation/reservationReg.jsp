			...
			<table>
				...
				<tr>
					<td colspan="2"><article class="agree_text">
                            ...
                            <br/>○ 개인정보의 수집의 목적 
                            <br/>- 본인 확인절차 
                            <br/>- 고지사항 전달, 불만 처리 등을 위한 원활한 의사소통 경로의 확보 
                            <br/>- OAB 텐트 대여 서비스를 이용 시 발생하는 사항에 있어서 이용자의 정보 확보 
                            <br/>- 기타 서비스를 이용하기 위하여 필요 
                            <br/>
                            <br/>○ 개인정보 수집 항목 
                            <br/>- 성명, 전화번호 (휴대폰, 전화번호)
                            <br/>
                            <br/>○ 개인정보 보유기간 
                            <br/>- 개인정보 보호법에 의거 법률로 정한 목적 이외의 다른 어떠한 목적으로도 사용되지 않으며 내부 규정에 의해 일정 기간 저장 
                            <br/>
                            <br/>○ 동의하지 않을 경우의 처리 
                            <br/>- 이용자는 개인정보 수집 동의에 거부할 수 있으며, 이 경우 대여서비스이용이 불가합니다.</article> 
                            <br/>
						<label><input class="agree" type="checkbox" value="약관동의"><strong>본인은 개인정보 보호법 제15조에 의거하여 본인의
							개인정보를 제공할 것을 동의합니다.</strong></label></td>
				</tr>
				<tr>
