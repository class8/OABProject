...
<link href="/resources/include/css/terms.css" rel="stylesheet">
</head>
<body>
	<div class="terms_container">
		<p class="terms_title">이용약관</p>
		<article class="terms_text">
		 <strong>제1장 총칙</strong>
                            <br/>
                            <br/>
                            <strong>제1조(목적)</strong>
                            <br/> 
                            본 약관은 OAB텐트 (이하 "당 사이트")가 제공하는 모든 서비스(이하 "서비스")의 이용조건 및 절차, 이용자와 당 사이트의 권리, 의무, 책임사항과 기타 필요한 사항을 규정함을 목적으로 합니다.                            
                            <br/>
                            <br/>
