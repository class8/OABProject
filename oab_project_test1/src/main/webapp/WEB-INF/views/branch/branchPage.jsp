...
<link href="/resources/include/css/branch.css" rel="stylesheet">
</head>
<body>

	<section>
		<p id="branch_text1">
			우리의 한강이 보다 아름다운 시간들로 기억 될 수 있게 노력하는 <span><strong>OAB
					서울 지점</strong></span>들을 소개합니다
		</p>
		<div>
			...
			<article class="article1">
				...
				<p id="branch_content">
					영등포구 여의나루로 117, 서울 상가 112호 1층  <br>여의 나루 1번출구 좌측 방향 직진 후 서울
					상가에 위치하고 있습니다. <br>별도의 주차 공간 없습니다.
				</p>
			</article>
			...
			<article class="article2">
				...
				<p id="branch_content">
					광진구 자양동 354 광진트라 팰리스  <br> 뚝섬유원지 1번 출구 바로 옆에 위치하고 있습니다 <br>
					별도의 주차 공간 없습니다.
				</p>
			...
			<article class="article3">
				...
				<p id="branch_content">
					서초구 신반포로 23길 41 잠원쇼핑센터 1층 <br> 잠원 쇼핑센터 1층, 반층 위에 위치하고 있습니다 <br>별도의
					주차 공간 없습니다.
				</p>
			</article>
