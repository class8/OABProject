...
public class AdminProductController {
	...
	public String adminProductList(@ModelAttribute ProductVO pvo , Model model) {
		log.info("productList Controller 호출 성공");
	...
	public String adminProductInsert(@ModelAttribute ProductVO pvo, Model model,HttpServletRequest request) throws IllegalStateException,IOException,Exception {
	...
	public String adminproductUpdate(@ModelAttribute ProductVO pvo , HttpServletRequest request ) throws IllegalStateException,IOException {
		...
		if(result == 1) {
			url = "/admin/product/adminProductDetail?pt_number="+pvo.getPt_number()+"&page="+pvo.getPage()+"&pageSize="+pvo.getPageSize();
		}
		return "redirect:" + url;
	}
